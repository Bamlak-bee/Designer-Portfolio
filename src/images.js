...
//gallery
export const landing = require('./icons/Frame745.png');
export const shemach = require('./icons/shemcah.png');
export const jivan = require('./icons/Frame760.png');
export const web = require('./assets/images/web.png');
export const phone = require('./assets/images/phone.png');
export const pen = require('./assets/images/pen.png');

export const persona1 = require('./assets/images/persona_img/Frame 209.png');
export const persona2 = require('./assets/images/persona_img/Frame 211.png');
export const persona3 = require('./assets/images/persona_img/Frame 212.png');

export const mock3 = require('./mock3.png');
//lofi
export const lofi1 = require('./assets/images/lofi_img/Login_wireframelofi.png');
export const lofi2 = require('./assets/images/lofi_img/Homescreen_wireframelofi.png');
export const lofi3 = require('./assets/images/lofi_img/Order_summary_wireframelofi.png');
export const lofi4 = require('./assets/images/lofi_img/PRODUCT_wireframelofi.png');
export const lofi5 = require('./assets/images/lofi_img/Vegg-listlofi.png');
export const lofi6 = require('./assets/images/lofi_img/13 Pro - 65lofi-1.png');
export const lofi7 = require('./assets/images/lofi_img/13 Pro - 65lofi.png');
export const lofi8 = require('./assets/images/lofi_img/Checkoutlofi.png');
export const process = require('./Group667.png');
//overview
export const sol = require('./assets/illustration/solution.png');
export const goal = require('./assets/illustration/goal.png');
export const overview = require('./assets/illustration/overview.png');
export const prob = require('./assets/illustration/problem.png');

export const  scr1 = require('./assets/images/hi-fi/onboarding/on1.png');
export const  scr2 = require('./assets/images/hi-fi/onboarding/on2.png');
export const  scr3 = require('./assets/images/hi-fi/onboarding/on3.png');
export const  scr4 = require('./assets/images/hi-fi/onboarding/on4.png');
